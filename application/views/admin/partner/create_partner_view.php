                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    echo form_textarea('content_vi', set_value('content_vi', '', false), 'class="form-control teacher-content"')
                                    ?>
                                </div>
                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    echo form_textarea('content_en', set_value('content_en', '', false), 'class="form-control teacher-content"')
                                    ?>
                                </div>
