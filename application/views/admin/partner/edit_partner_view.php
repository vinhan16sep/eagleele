                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    <?php
                                    echo form_label('Tên', 'name_vi');
                                    echo form_error('name_vi');
                                    echo form_input('name_vi', set_value('name_vi', $partner['name_vi']), 'class="form-control name_vi"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('slug_vi', set_value('slug_vi', $partner['slug_vi']), 'class="form-control slug_vi" readonly="readonly"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_description_vi', set_value('meta_description_vi', $partner['meta_description_vi']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_keywords_vi', set_value('meta_keywords_vi', $partner['meta_keywords_vi']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_textarea('content_vi', set_value('content_vi', $partner['content_vi'], false), 'class="form-control teacher-content"')
                                    ?>
                                </div>
                    ...
                    <div id="collapseThree" class="panel-collapse collapse">
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    <?php
                                    echo form_label('Name', 'name_en');
                                    echo form_error('name_en');
                                    echo form_input('name_en', set_value('name_en', $partner['name_en']), 'class="form-control name_en"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('slug_en', set_value('slug_en', $partner['slug_en']), 'class="form-control slug_en" readonly="readonly"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_description_en', set_value('meta_description_en', $partner['meta_description_en']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_keywords_en', set_value('meta_keywords_en', $partner['meta_keywords_en']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_textarea('content_en', set_value('content_en', $partner['content_en'], false), 'class="form-control teacher-content"')
                                    ?>
                                </div>
