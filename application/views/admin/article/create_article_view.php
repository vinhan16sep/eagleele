                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('type', array('0' => 'Event', '1' => 'News'), set_value('type', 0), 'class="form-control type"');
                                    ?>
                                </div>
                                ...
                                <div class="form-group etime">
                                    ...
                                    echo form_dropdown('event_hour', $hours, set_value('event_hour', ''), 'class="form-control"');
                                    ?>
                                    <?php
                                    $minutes = array(
                                        '' => 'Phút'
                                    ...
                                    echo form_dropdown('event_min', $minutes, set_value('event_min', ''), 'class="form-control"');
                                    ?>
                                </div>
                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group elocation">
                                    ...
                                    echo form_input('location_vi', set_value('location_vi'), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group eaddress">
                                    ...
                                    echo form_input('address_vi', set_value('address_vi'), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group ecost">
                                    ...
                                    echo form_input('cost_vi', set_value('cost_vi'), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group elocation">
                                    ...
                                    echo form_input('location_en', set_value('location_en'), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group eaddress">
                                    <?php
                                    ...
                                    echo form_input('address_en', set_value('address_en'), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group ecost">
                                    <?php
                                    ...
                                    echo form_input('cost_en', set_value('cost_en'), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
