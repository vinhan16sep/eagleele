                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('type', array('0' => 'Video', '1' => 'Hình ảnh', '2' => 'Bài học', '3' => 'Chia sẻ'), set_value('type', $library['type']), 'class="form-control type"');
                                    ?>
                                </div>
                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    echo form_input('title_vi', set_value('title_vi', $library['title_vi']), 'class="form-control title_vi"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('slug_vi', set_value('slug_vi', $library['slug_vi']), 'class="form-control slug_vi" readonly="readonly"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_description_vi', set_value('meta_description_vi', $library['meta_description_vi']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_keywords_vi', set_value('meta_keywords_vi', $library['meta_keywords_vi']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group description">
                                    ...
                                    echo form_textarea('description_vi', set_value('description_vi', $library['description_vi']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_textarea('content_vi', set_value('content_vi', $library['content_vi'], false), 'class="form-control blog-content"')
                                    ?>
                                </div>
                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    echo form_input('title_en', set_value('title_en', $library['title_en']), 'class="form-control title_en"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('slug_en', set_value('slug_en', $library['slug_en']), 'class="form-control slug_en" readonly="readonly"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_description_en', set_value('meta_description_en', $library['meta_description_en']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_keywords_en', set_value('meta_keywords_en', $library['meta_keywords_en']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group description">
                                    <?php
                                    ...
                                    echo form_textarea('description_en', set_value('description_en', $library['description_en']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_textarea('content_en', set_value('content_en', $library['content_en'], false), 'class="form-control blog-content"')
                                    ?>
                                </div>
