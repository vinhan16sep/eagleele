                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    <?php
                                    echo form_label('Trạng thái / ', 'status');
                                    echo form_error('status');
                                    echo form_dropdown('status', array('0' => 'Hết hạn', '1' => 'Đang tuyển'), set_value('status', $recruitment['status']), 'class="form-control"');
                                    ?>
                                </div>
                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    echo form_input('title_vi', set_value('title_vi', $recruitment['title_vi']), 'class="form-control title_vi"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('slug_vi', set_value('slug_vi', $recruitment['slug_vi']), 'class="form-control slug_vi" readonly="readonly"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_description_vi', set_value('meta_description_vi', $recruitment['meta_description_vi']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_keywords_vi', set_value('meta_keywords_vi', $recruitment['meta_keywords_vi']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group description">
                                    ...
                                    echo form_textarea('description_vi', set_value('description_vi', $recruitment['description_vi']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_textarea('content_vi', set_value('content_vi', $recruitment['content_vi'], false), 'class="form-control blog-content"')
                                    ?>
                                </div>
                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    echo form_input('title_en', set_value('title_en', $recruitment['title_en']), 'class="form-control title_en"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('slug_en', set_value('slug_en', $recruitment['slug_en']), 'class="form-control slug_en" readonly="readonly"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_description_en', set_value('meta_description_en', $recruitment['meta_description_en']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_keywords_en', set_value('meta_keywords_en', $recruitment['meta_keywords_en']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group description">
                                    <?php
                                    ...
                                    echo form_textarea('description_en', set_value('description_en', $recruitment['description_en']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_textarea('content_en', set_value('content_en', $recruitment['content_en'], false), 'class="form-control blog-content"')
                                    ?>
                                </div>
