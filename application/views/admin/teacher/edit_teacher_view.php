                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('gender', array('0' => 'Ông', '1' => 'Bà'), set_value('gender', $teacher['gender']), 'class="form-control"');
                                    ?>
                                </div>
                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    echo form_input('name_vi', set_value('name_vi', $teacher['name_vi']), 'class="form-control name_vi"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('slug_vi', set_value('slug_vi', $teacher['slug_vi']), 'class="form-control slug_vi" readonly="readonly"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_description_vi', set_value('meta_description_vi', $teacher['meta_description_vi']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_keywords_vi', set_value('meta_keywords_vi', $teacher['meta_keywords_vi']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group description">
                                    ...
                                    echo form_textarea('position_vi', set_value('position_vi', $teacher['position_vi']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_textarea('bio_vi', set_value('bio_vi', $teacher['bio_vi'], false), 'class="form-control teacher-content"')
                                    ?>
                                </div>
                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    echo form_input('name_en', set_value('name_en', $teacher['name_en']), 'class="form-control name_en"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('slug_en', set_value('slug_en', $teacher['slug_en']), 'class="form-control slug_en" readonly="readonly"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_description_en', set_value('meta_description_en', $teacher['meta_description_en']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_input('meta_keywords_en', set_value('meta_keywords_en', $teacher['meta_keywords_en']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group description">
                                    <?php
                                    ...
                                    echo form_textarea('position_en', set_value('position_en', $teacher['position_en']), 'class="form-control"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_textarea('bio_en', set_value('bio_en', $teacher['bio_en'], false), 'class="form-control teacher-content"')
                                    ?>
                                </div>
