                ...
                <div class="checkout-step-body">
                    <div class="row">
                        <div class="form-group">
                            ...
                            echo form_input('name', set_value('name'), 'class="form-control name"');
                            ?>
                        </div>
                        <div class="form-group">
                            <?php
                            ...
                            echo form_input('slug', set_value('slug'), 'class="form-control slug" readonly="readonly"');
                            ?>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            echo form_textarea('content', set_value('content', '', false), 'class="form-control blog-content"')
                            ?>
                        </div>
                    </div>
            </div>
