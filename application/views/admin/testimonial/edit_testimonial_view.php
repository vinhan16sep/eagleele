                ...
                <div class="checkout-step-body">
                    <div class="row">
                        <div class="form-group">
                            ...
                            echo form_input('name', set_value('name', $testimonial['name']), 'class="form-control name"');
                            ?>
                        </div>
                        <div class="form-group">
                            <?php
                            ...
                            echo form_input('slug', set_value('slug', $testimonial['slug']), 'class="form-control slug" readonly="readonly"');
                            ?>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            echo form_input('position', set_value('position', $testimonial['position']), 'class="form-control"');
                            ?>
                        </div>
                        <div class="form-group">
                            <?php
                            ...
                            echo form_textarea('content', set_value('content', $testimonial['content'], false), 'class="form-control blog-content"')
                            ?>
                        </div>
                    </div>
            </div>
