                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    echo form_input('title_vi', set_value('title_vi', $introduce['title_vi']), 'class="form-control title_vi"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_textarea('content_vi', set_value('content_vi', $introduce['content_vi'], false), 'class="form-control blog-content"')
                                    ?>
                                </div>
                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    echo form_input('title_en', set_value('title_en', $introduce['title_en']), 'class="form-control title_en"');
                                    ?>
                                </div>
                                <div class="form-group">
                                    <?php
                                    ...
                                    echo form_textarea('content_en', set_value('content_en', $introduce['content_en'], false), 'class="form-control blog-content"')
                                    ?>
                                </div>
