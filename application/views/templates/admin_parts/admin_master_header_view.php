...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap CSS -->    
        <link type="text/css" rel="stylesheet" href="<?php echo site_url('assets/public/libraries/css/bootstrap.css'); ?>">
        <!-- bootstrap theme -->
        ...
        <script src="<?php echo site_url('assets/public/libraries/js/jquery-birthday-picker.min.js'); ?>"></script>
    </head>
        ...
        if ($this->ion_auth->logged_in()) {
            ...
            <section id="container" class="">
                ...
                <header class="header dark-bg">
                    ...
                    <!--logo start-->
                    <a href="<?php echo site_url('index'); ?>" class="logo">MATO CREATIVE <span class="lite">Admin</span></a>
                    <!--logo end-->
